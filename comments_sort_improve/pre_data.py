...
org_train_file = 'data/training.1600000.processed.noemoticon.csv'
org_test_file = 'data/testdata.manual.2009.06.14.csv'
...
def create_lexicon(train_file):
	...
	#with codecs.open(train_file, "r", encoding='utf-8', errors='ignore') as f:
	with io.open(train_file, buffering=10000,errors='ignore') as f:
		try:
			a= 0
